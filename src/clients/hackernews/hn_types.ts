export type Item = {
    ...
    type?: "link" | "ask" | "job", // note: the api will return `link` for `ask` responses sometimes.
    content?: string, // html, must be parsed and transformed. contains <p>, <a>, <pre><code>, …
    url: string, // eg `item?id=…` (no slash)
    domain?: string, // eg `twitter.com`
