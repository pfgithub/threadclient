...
const tests: Instance[] = [
  // https://mastodon.social/api/v1/instance
  {
    ...
    stats: { user_count: 677600, status_count: 35477609, domain_count: 22753 },
    thumbnail:
    ...
    contact_account: {
      ...
      avatar:
        "https://files.mastodon.social/accounts/avatars/000/000/001/original/ccb05a778962e171.png",
      avatar_static:
        "https://files.mastodon.social/accounts/avatars/000/000/001/original/ccb05a778962e171.png",
      header:
        "https://files.mastodon.social/accounts/headers/000/000/001/original/3b91c9965d00888b.jpeg",
      header_static:
        "https://files.mastodon.social/accounts/headers/000/000/001/original/3b91c9965d00888b.jpeg",
      followers_count: 106778,
      following_count: 281,
      statuses_count: 72272,
      last_status_at: "2022-04-26",
      emojis: [],
      fields: [
        {
          name: "Patreon",
  ...
  // https://mastodon.lol/api/v1/instance
  {
    ...
    description:
      "A Mastodon server friendly towards anti-fascists, members of the LGBTQ+ community, hackers, and the like.",
    email: "support@mastodon.lol",
    version: "3.5.1",
    urls: { streaming_api: "wss://mastodon.lol" },
    stats: { user_count: 5465, status_count: 86145, domain_count: 5864 },
    thumbnail:
      "https://mastodon.lol/system/site_uploads/files/000/000/001/original/preview-9a17d32fc48369e8ccd910a75260e67d.jpg",
    languages: ["en"],
    registrations: true,
    approval_required: false,
    ...
    contact_account: {
      ...
      username: "nathan",
      acct: "nathan",
      display_name: "Nathan 🏳️‍🌈",
      locked: false,
      bot: false,
      discoverable: true,
      group: false,
      created_at: "2020-06-04T00:00:00.000Z",
      note: "\u003cp\u003e⚙️ Mastodon.lol admin\u003c/p\u003e\u003cp\u003e🏳️‍🌈 Pan cis guy\u003c/p\u003e\u003cp\u003e🐕 Send me photos of you dog\u003c/p\u003e",
      url: "https://mastodon.lol/@nathan",
      avatar:
        "https://mastodon.lol/system/accounts/avatars/000/000/001/original/1acd35410cb98187.png",
      avatar_static:
        "https://mastodon.lol/system/accounts/avatars/000/000/001/original/1acd35410cb98187.png",
      header:
        "https://mastodon.lol/system/accounts/headers/000/000/001/original/67608750ad6b0645.jpeg",
      header_static:
        "https://mastodon.lol/system/accounts/headers/000/000/001/original/67608750ad6b0645.jpeg",
      ...
      fields: [
        ...
        { name: "Gay", value: "Very", verified_at: null },
        { name: "Shit", value: "Posting", verified_at: null },
      ],
    },
    rules: [
      { id: "1", text: "No hate speech/discrimination/etc" },
      { id: "2", text: "No oppressive language or actions" },
      { id: "3", text: "No harassment/stalking" },
      {
        id: "4",
        text: "NSFW content (including nudity) is permitted so long as it's marked as sensitive and behind a content warning",
      },
      { id: "5", text: "No gore or graphic violence" },
      { id: "6", text: "Respect peoples' pronouns" },
      { id: "7", text: "No sexual depictions of children" },
      { id: "8", text: "No automated spam (friendly bots ok)" },
      { id: "9", text: "No doxxing" },
      {
        id: "10",
        text: "No begging for money (giving people the option to donate is totally fine)",
      },
      {
        id: "11",
        text: "Accounts created solely for the purpose of posting pornographic content are not permitted unless it's your own content",
      },
    ],
  },
];
...
const account_test: Account = {
  ...
  avatar:
    "https://files.mastodon.social/accounts/avatars/000/023/634/original/6ca8804dc46800ad.png",
  avatar_static:
    "https://files.mastodon.social/accounts/avatars/000/023/634/original/6ca8804dc46800ad.png",
  header:
    "https://files.mastodon.social/accounts/headers/000/023/634/original/256eb8d7ac40f49a.png",
  header_static:
    "https://files.mastodon.social/accounts/headers/000/023/634/original/256eb8d7ac40f49a.png",
  followers_count: 547,
  following_count: 404,
